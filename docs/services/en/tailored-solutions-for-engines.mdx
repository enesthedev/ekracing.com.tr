export const metadata = {
    ...
    thumbnail: '/images/services/engine-build.jpg',
    description: 'We specialize in creating custom-tuned engines that match each vehicle\'s unique needs. Understanding that every engine is different, we focus on making specific changes to improve its performance.'
}
