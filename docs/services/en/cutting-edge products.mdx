export const metadata = {
    ...
    thumbnail: '/images/services/cutting-edge-products.jpg',
    description: 'We make special car parts just for you, no matter what car brands we work with. Our team focuses on creating items like exhaust manifolds, intercoolers, flanges, and ethanol-based products, all designed to suit your specific needs.'
}
